...
svg {
    ...
    z-index: -1;
    border-radius: 5px;
    filter: brightness(0.7); /* Ajusta el brillo para un fondo oscuro */
}
...
a {
    ...
    color: #FFFFFF; /* Blanco para enlaces sobre fondo oscuro */
    margin-left: 1em;
...
a:hover {
    ...
    color: #3B82F6; /* Azul vibrante en hover */
}
