...
const educacion = ref ([]);
educacion.value = [
    {fecha: "2024", title: "Técnicatura Universitaria en Programacion", descripcion: "Actualmente cursando tecnicatura en programacion en UTN San Rafael", enlace:"https://www.frsr.utn.edu.ar"},
    {fecha: "2023", title: "Desarrollador software Alura latam", descripcion:"Estudios Programacion, Frond End, Data Science", enlace: "https://www.aluracursos.com/"},
    {fecha: "2017", title: "Electronica aplicada a la industria", descripcion: "Realice 2 años de estudios en prácticas de componentes smd, identificación en corto directo", enlace: "https://www.santale.com.ar/"},
    {fecha: "2015", title: "Cursado de ingeniería Electromecánica UTN SR", descripcion: "Cursado primeros 2 años de Ingenieria", enlace: "https://www.frsr.utn.edu.ar"},
    {fecha: "2014", title: "Tecnico Quimico", descripcion: "Estudios Secundaria ETQ 4-017 Bernardino Izuel", enlace: "https://dti.mendoza.edu.ar/gem/ingreso/publico/escuela/1005/2"}
]
</script>
