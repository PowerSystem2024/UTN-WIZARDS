...
# Realizar dos funciones pra convertir de grados celsius
# a fahrenheit y viseversa.
# Investigar las formulas

# Funcion que convierte de celsius a fehrenheit
def celsius_fahrenheit(celsius):
    return celsius * 9 / 5 + 32 # La presedencia: multiplicacion, divicion y suma
