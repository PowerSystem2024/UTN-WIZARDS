/*
Proyecto caja:
Ejercicio 1: Crear un proyecto según las espesificaciones
...
public class PruebaCaja {
    public static void main (String args[]){ //Medoto main
        //Variables locales
        int medidaAncho = 3; //Valores ingresados en código duro
        int medidaAlto = 2;
        int medidaProf = 6;
        
        Caja caja1 = new Caja(); //Instaciamos el objeto, contructor vacio
